...
export const Hero = () => {
  return (
   <div className="w-screen h-[120vh] flex flex-col items-center -z-10  bg-[#B3B3B3]">
  <div className="w-[90vw] h-[70vh] relative flex items-center justify-center ">
        {/* Heading */}
        <h4 className="text-[17vw] md:text-[12vw] -translate-x-1/2 -translate-y-1/2 absolute font-[500] z-50 md:top-20 top-10 left-1/2 text-nowrap -tracking-[1px] text-white uppercase">
          We create
        </h4>
