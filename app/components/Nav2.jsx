  ...
  return (
    <>
      ...
      <div className="flex items-center justify-between  px-6 md:px-12 py-6">
        <Link href="/">
          <span className="text-black cursor-pointer">©Code By Farhan</span>
        </Link>
        ...
        <ul className="flex items-center gap-8">
          ...
          {navItems.map((item, index) => (
            <Magnetic key={index}>
              <Link href={item.link}>
                <li className="text-black xl:block hidden relative group cursor-pointer">
                  {item.name}
                  <span className="w-[5px] h-[5px] group-hover:opacity-100 opacity-0 absolute -bottom-3 left-1/2 transition-all duration-300 rounded-full bg-black"></span>
                </li>
              </Link>
            </Magnetic>
          ))}
          ...
          <Magnetic>
            <li
              ...
              className="text-black xl:hidden flex items-center gap-1 cursor-pointer"
            >
